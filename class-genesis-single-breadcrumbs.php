 ...
 * @author  Gary Jones <gary@gamajo.com>
 */
class Genesis_Single_Breadcrumbs {
	 ...
	 * @var      string
	 */
	const PLUGIN_SLUG = 'genesis-single-breadcrumbs';
	...
	private static function single_activate() {
		if ( 'genesis' != basename( TEMPLATEPATH ) ) {
                ...
                wp_die( sprintf( __( 'Sorry, you can&rsquo;t activate this plugin unless you have a child theme of the <a href="%s">Genesis Framework</a> active.', 'genesis-single-breadcrumbs'), 'http://genesis-theme-framework.com/' ) );
        }
	}
